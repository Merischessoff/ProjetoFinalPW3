...
import com.example.projetofinalpw3.adapter.MyAdapterListBancoHistSocAssociar;
    ...
    private void carregaHistoriasSociais(){
        ...
        call2.enqueue(new Callback<List<BancoDeHistoriaSocial>>() {
            ...
            public void onResponse(Call<List<BancoDeHistoriaSocial>> call, Response<List<BancoDeHistoriaSocial>> response) {
                ...
                MyAdapterListBancoHistSocAssociar myAdapterListHistAssociar =
                        new MyAdapterListBancoHistSocAssociar(getActivity().getBaseContext(), bancoDeHistorias, token, idUsuarioLeitor, emailUsuarioLeitor, emailUsuarioResponsavel);
